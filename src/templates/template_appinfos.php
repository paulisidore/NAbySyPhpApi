<?php
     ...
     */
      ...
      */
     //N::Init("YOUR_APP_NAME","ORGANISATION_NAME","ORGANISATION_ADDRESS","ORGANISATION_CONTACT","DATABASE_NAME","MASTER_DATABASE_NAME","DATABASE_SERVER","DATABSE_USER","DATABASE_PASSWORD",DATABASE_PORT);
